...
//                    setDevideTripData()
    ...
    func questionTitleListSet() {
//        print("질문 제목 리스트 추가된거 확인")
//        questionTitleList.append(questionDataList[0].title)
//        print(questionTitleList)
//        print("끝")
//        questionAnswerListSet()
    }
    
    func questionAnswerListSet() {
//        print("질문 대답 리스트 추가된거 확인")
//        questionAnswerList.append(questionDataList[0].content[0].answer)
...
//        case 0:
//            self.questionDataList[currentNumber].title
